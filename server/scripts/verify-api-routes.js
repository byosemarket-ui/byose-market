...
const ROUTES = [
  ...
  { method: "GET", path: "/api/hero-slides", expect: [200, 503] },
  { method: "GET", path: "/api/admin/hero-slides", expect: [401, 403] },
  { method: "PUT", path: "/api/admin/hero-slides/demo/move", expect: [401, 403, 404] },
  ...
  { method: "GET", path: "/api/admin/profile", expect: [401, 403] },
  { method: "PUT", path: "/api/admin/profile", expect: [401, 403] },
  { method: "POST", path: "/api/admin/profile/photo", expect: [401, 403] },
  { method: "DELETE", path: "/api/admin/profile/photo", expect: [401, 403] },
  { method: "GET", path: "/api/admin/security", expect: [401, 403] },
  { method: "GET", path: "/api/admin/security/sessions", expect: [401, 403] },
  { method: "GET", path: "/api/admin/security/login-history", expect: [401, 403] },
  { method: "GET", path: "/api/admin/security/trusted-devices", expect: [401, 403] },
  { method: "GET", path: "/api/admin/security/events", expect: [401, 403] },
  { method: "GET", path: "/api/admin/security/two-factor", expect: [401, 403] },
  { method: "GET", path: "/api/admin/password", expect: [401, 403] },
  { method: "POST", path: "/api/admin/password/validate", expect: [401, 403] },
  { method: "PUT", path: "/api/admin/password", expect: [401, 403] },
